 ...
 *
 *    knurled_cylh( Knurled cylinder height,\n
...
module knurl_help()
{
   ...
   echo("");
	...
	echo("");
	echo("        h       -   [ 12   ]  ,,  Height for the knurled cylinder    ");
	echo("        od      -   [ 25   ]  ,,  Cylinder's Outer Diameter before applying the knurled surfacefinishing.    ");
